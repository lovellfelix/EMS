...
if (isset($_POST['submitted'])) {
	...
	if ($_POST['sure'] == 'Yes') { // Delete the record.
		...
		// Make the query:
		$q = "DELETE FROM employee WHERE empid=$id LIMIT 1";		
	...
	$q = "SELECT CONCAT(emplastname, ', ', empfirstname) FROM employee WHERE empid=$id";
	$r = @mysqli_query ($dbc, $q);
	...
	<input type="hidden" name="id" value="' . $id . '" />
		...
		echo '<p class="error">This page has been accessed in error.</p> <br><br>';
	}
